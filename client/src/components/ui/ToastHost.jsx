...
// A lightweight global toast host that listens for 'peerfusion-toast' events
// and shows a top banner styled with existing .notification-alert-banner CSS.
// Usage: dispatch a CustomEvent('peerfusion-toast', { detail: { message, type } })
